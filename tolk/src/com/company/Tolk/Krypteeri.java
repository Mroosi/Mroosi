...
public class Krypteeri {
    int voti;
    String sisseTulevTekst;
    public Krypteeri(int myVot, String myTekstSisse) {
        voti = myVot;
    ...
    public String krypteeri() {
        ...
        for (int i = 0; i < tekst.length(); i++) {
            ...
            kryptVastus = kryptVastus + osaVastus;
        }
        return kryptVastus;
    }
